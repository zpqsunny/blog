...
## 成都任小满科技有限公司 (任我行集团) (2022.8 ~ 2025.4) - BI研发负责人(BI产品/数据仓库)
...
1. 负责公司BI工具产品研发(SpringBoot + React)
2. BI产品（含移动端）平台化开发管理
...
2. 实现功能自定义函数嵌套
3. 实现线性维度和离散维度分组汇总
4. 指标同环比/天气(高德)/国家地图/插件图表开发
5. 实现不同数据源处理方式及SQL方言统一化
6. 增加clickhouse数据源,增加minio文件上传,仪表板增加默认主题/自定义主题
7. BI工具平台化 **(移动端图表/控制器)**
8. 平台监测钉钉/邮件通知
9. 数仓开发 **(ods/dw/dm)**
10. 图表插件式开发
...
## 迪锐克斯科技无锡有限公司 (2020.11 ~ 2022.7) - 全栈Java开发
